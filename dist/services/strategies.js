...
exports.strategyEngine = exports.STRATEGIES = void 0;
exports.STRATEGIES = {
    sweep: {
        name: 'sweep',
...
class StrategyEngine {
     ...
     */
    async scoutBestSetups(symbols, llmProvider) {
        try {
...
Return ONLY a JSON array with confidence > 70.`;
     ...
     */
    async recommendStrategy(symbol, marketData, llmProvider) {
        try {
...
Recommend ONE primary strategy + 2 alternatives with confidence 1-100.`;
            ...
            return {
                symbol,
                recommendedStrategy: rec.primary,
                alternativeStrategies: rec.alternatives,
                reason: rec.reason,
     ...
     */
    async findArbitrageOpportunities(symbols, priceData) {
        const opportunities = [];
